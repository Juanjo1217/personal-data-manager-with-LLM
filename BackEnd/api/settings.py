...
SECRET_KEY = 'django-insecure-0lnhb981z96y&8w!@*-=x8ce^37ct_k#zy+0s0sjwi5e=27#(!'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True


# Configuración para desarrollo (sin seguridad)
...
DATABASES = {
    'default': {
        ...
        'HOST': os.getenv('POSTGRES_HOST', 'postgres-container'),
